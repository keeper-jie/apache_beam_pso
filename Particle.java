...
//        }
    ...
    public static void swarm_init() throws IOException {
        ...
        for (int i = 0; i < swarm_size; i++) {
            ...
            Arrays.fill(b_lower, -10);
            p.b_lower = b_lower;

            double[] b_upper = new double[dimension];
            Arrays.fill(b_upper, 10);
            p.b_upper = b_upper;
...
//            }
        ...
        FileWriter writer = new FileWriter("/share/word-count-beam/src/main/java/apache_beam_pso/pso_init_rosenbrock_function_2000particle_30dimension.txt");
        for (particle str : swarm) {
            writer.write(str + System.lineSeparator());
        }
        writer.close();
